        ...
        <div className={styles.container}>
            ...
            <div className={styles.memberList}>
                <div className={styles.memberCard}>
                    ...
                    <p className={styles.memberClass}>Turma: 1TDSPI</p> 
                    <a href="https://www.linkedin.com/in/lucas-h-9694582b6" target="_blank" rel="noopener noreferrer" className={styles.link}>LinkedIn</a>
                ...
                <div className={styles.memberCard}>
                    ...
                    <p className={styles.memberClass}>Turma: 1TDSR</p> 
